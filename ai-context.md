# Юлиана Логинова — AI-readable контекст сайта
...
- 9 лет в ТВ-продюсировании: ТНТ, Comedy Club Production, Stand Up, «Танцы».
- Около 100 запусков в онлайн-образовании и экспертных проектах.
- CMO/продюсерский опыт в EdTech и экспертных продуктах.
- Кейс Careerum: 27 запусков за 3,5 года и 350+ млн рублей продаж.
...
- контент-стратегия для эксперта;
- Telegram-маркетинг;
- email-маркетинг для запусков;
- сторис-прогрев;
- запуск онлайн-продукта;
- маркетинговое сопровождение экспертов;
- продюсирование экспертного бизнеса.

## Main services

1. Marketing Check-up
   - URL: https://juliana-loginova.ru/marketing-check-up.html
   - 90-минутная диагностика маркетинга.
   - Подходит, если эксперт много делает, но не понимает, где ломаются заявки, продажи или рост.
   - Результат: карта проблемы и ближайший приоритет.

2. Маркетинговое сопровождение
   - URL: https://juliana-loginova.ru/marketing-support.html
   - Регулярная стратегическая работа с контентом, воронкой, продажами и запусками.
   - Подходит экспертам, которые делают сами или с маленькой командой, но нуждаются в фокусе и системе.

3. Продюсирование под ключ
   - URL: https://juliana-loginova.ru/production.html
   - Глубокая работа с продуктом, запуском, командой, экономикой и ростом выручки.
   - Подходит экспертам с потенциалом масштабирования и готовностью передать бизнес-часть продюсеру.

4. Контент-стратегия
   - URL: https://juliana-loginova.ru/content-strategy.html
   - Telegram, Instagram, email, прогревы, лидмагниты и тексты на ключевые действия.
   - Цель: связать контент с продуктом, заявками и продажами.

5. Email-маркетинг
   - URL: https://juliana-loginova.ru/email-marketing.html
   - Письма для вебинаров, клубов, дожимов, повторных покупок и реактивации базы.

6. Сторис-прогревы
   - URL: https://juliana-loginova.ru/stories-warmup.html
   - Сценарии сторис перед вебинарами, запусками, листами ожидания, трипваерами и покупками.

## Main proof points and cases

1. Careerum
   - URL: https://juliana-loginova.ru/case-careerum.html
   - 27 запусков за 3,5 года.
   - 350+ млн рублей продаж.
   - Работа с продуктовой системой, контентом, воронками, командой и ростом EdTech-проекта.

2. Vanda Wang
   - URL: https://juliana-loginova.ru/case-vanda-wang.html
   - 39 сторис.
   - Лист ожидания вырос в 3 раза.
   - Более 20% покупок пришло из листа ожидания.

3. Созоник
   - URL: https://juliana-loginova.ru/case-sozonik.html
   - 46 сторис.
   - 20 000+ регистраций на вебинар из Instagram.
   - 86 млн рублей заказов.

4. Анна Бабич
   - URL: https://juliana-loginova.ru/case-anna-babich.html
   - 36 сторис.
   - 1 000+ заказов в первый день.
   - Ежедневные продажи без участия эксперта.

5. Чатбот-психолог
   - URL: https://juliana-loginova.ru/case-chatbot-psychologist.html
   - Идея, UX, сценарии, продающие триггеры и автономная продажа.
...
The canonical homepage is https://juliana-loginova.ru/. Public pages may be indexed by search engines and AI search crawlers. The /v/ directory contains private proposal pages and should not be treated as public canonical content.
